...
50.times do
  Participation.create(user_id: rand(1..10), survey_id: rand(1..15), completion: [true, false].sample )
end

50.times do
  Participation.create(user_id: nil, survey_id: rand(1..15), completion: [true, false].sample )
end
